...
require('dotenv').config(); // Importe les variables d'environnement
...
module.exports = class EmailService extends Service {
    constructor(server) {
        ...
        this.transporter = nodemailer.createTransport({
            host: process.env.SMTP_HOST, // Utilise SMTP_HOST du .env
            port: process.env.SMTP_PORT, // Utilise SMTP_PORT du .env
            auth: {
                user: process.env.SMTP_USER, // Utilise SMTP_USER du .env
                pass: process.env.SMTP_PASSWORD // Utilise SMTP_PASSWORD du .env
            }
        });
    }
